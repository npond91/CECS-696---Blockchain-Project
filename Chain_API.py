...
# instantiate the Flask class - This is our node
...
# This function used so
@my_chain_app.route('/shutdown', methods=['POST'])
def shutdown():
    shutdown_server()
...
if __name__ == '__main__':
    my_chain_app.run(host='0.0.0.0', port=5000)


# print memory trace data to console
# Requires 'graceful' shutdown through Postman call
# Stopping Flask via this IDE will not show this data
snapshot = tracemalloc.take_snapshot()
top_stats = snapshot.statistics('lineno')
print("Current Memory Usage: %d" % tracemalloc.get_tracemalloc_memory() + " bytes")
print("Current Memory Usage: %d, Peak Memory Usage %d: " % tracemalloc.get_traced_memory())
print("[ Top 10 ]")
